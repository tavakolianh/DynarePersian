function write_latex_parameter_table_persian
...
fprintf(fid, ['\\caption{مقادیر پارامترها}\\\\%%\n']);

fprintf(fid, '\\toprule%%\n');
fprintf(fid, '\\multicolumn{1}{c}{\\textbf{پارامتر}} &\n');
fprintf(fid, '\\multicolumn{1}{c}{\\textbf{مقدار}} ');
if Long_names_present==1
...
if Long_names_present==1
    ...
    fprintf(fid, '\\multicolumn{2}{c}{{\\tablename} \\thetable{} -- ادامه}\\\\%%\n');
end
fprintf(fid, '\\midrule%%\n');
fprintf(fid, '\\multicolumn{1}{c}{\\textbf{پارامتر}} &\n');
fprintf(fid, '\\multicolumn{1}{c}{\\textbf{مقدار}} ');
