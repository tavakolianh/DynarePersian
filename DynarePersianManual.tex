...
متأسفانه تنظیمات لازم برای پارسی‌سازی MATLAB در سیستم عامل ویندوز به راحتی مک نیست. دلیل آن هم این است که با وجود این‌که دستور مورد اشاره در تنظیمات مک باید در MATLAB تحت ویندوز نیز اجرا شود اما به‌راحتی ‪Encoding‬‬‬ جاوا را به ‪\lr{‪UTF8}‬‬‬‬ تبدیل نمی‌کند. با اجرای دستور زیر داریم:
\begin{latin}
\begin{lstlisting}[basicstyle=\scriptsize]
feature('DefaultCharacterSet', 'UTF-8')
ans =
