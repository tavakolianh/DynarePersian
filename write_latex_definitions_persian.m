function write_latex_definitions_persian
...
if M_.exo_det_nbr == 0
    tables = {'متغیرهای برون‌زا', 'متغیرهای برون‌زا', 'پارامترها'};
    M_var_root = {'M_.endo', 'M_.exo', 'M_.param'};
else
    tables = {'متغیرهای برون‌زا', 'متغیرهای برون‌زا', 'متغیرهای درون‌زای غیرتصادفی', 'پارامترها'};
...
for i=1:length(tables)
    ...
    fprintf(fid, '\\hline%%\n');
    fprintf(fid, '\\multicolumn{1}{c}{\\textbf{متغیر}} &\n');
    fprintf(fid, '\\multicolumn{1}{c}{\\textbf{\\LaTeX}} &\n');
    fprintf(fid, '\\multicolumn{1}{c}{\\textbf{توضیحات}}\\\\%%\n');
    fprintf(fid, '\\hline\\hline%%\n');
    fprintf(fid, '\\endfirsthead\n');

    fprintf(fid, '\\multicolumn{3}{c}{{\\tablename} \\thetable{} -- ادامه}\\\\%%\n');
    fprintf(fid, '\\hline%%\n');
    fprintf(fid, '\\multicolumn{1}{c}{\\textbf{متغیر}} &\n');
    fprintf(fid, '\\multicolumn{1}{c}{\\textbf{\\LaTeX}} &\n');
    fprintf(fid, '\\multicolumn{1}{c}{\\textbf{توضیحات}}\\\\%%\n');
